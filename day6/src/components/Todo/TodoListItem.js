...
const TodoListItem = ({ todo, toggleTodo, removeTodo, editName: editTodo }) => {
  ...
  return editing ? (
    ...
    <>
      <div className={`${styles.todoItem} ${todo.done ? styles.checked : ''}`}>
        ...
        <div className={styles.todoActions}>
          ...
          <button onClick={() => removeTodo(todo.id)} className={styles.delete}>
            Delete
          </button>
        </div>
      </div>
